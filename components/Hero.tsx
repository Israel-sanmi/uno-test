      ...
      <div className="mx-auto max-w-7xl px-4 py-14">
        <div className="text-center max-w-3xl mx-auto">
          <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-sm bg-main/10 text-main text-xs font-semibold">
            <ShieldCheck className="size-3.5" /> First trusted escrow marketplace
          </span>
        ...
        <div className="mt-10 max-w-4xl mx-auto">
          <div className="flex items-center gap-2 p-3 bg-white rounded-2xl border-2 border-main shadow-lg shadow-main/10">
